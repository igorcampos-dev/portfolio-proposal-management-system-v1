...
docker compose -f proposal-management-api/compose.yaml up database -d --build
sleep 10

docker compose -f proposal-management-api/compose.yaml up proposal-management-api -d --build
sleep 10
